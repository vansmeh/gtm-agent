...
class PersonRow(Base):
    ...
    identity_excerpt: Mapped[str] = mapped_column(Text, default="")
    identity_confidence: Mapped[float] = mapped_column(Float)
    responsibility_status: Mapped[str] = mapped_column(String(20), default="unknown")
    selection_status: Mapped[str] = mapped_column(String(40), default="weak_candidate")
    first_seen: Mapped[str | None] = mapped_column(String(20), nullable=True)
    last_seen: Mapped[str | None] = mapped_column(String(20), nullable=True)
    role_published_at: Mapped[str | None] = mapped_column(String(20), nullable=True)
    validity: Mapped[str] = mapped_column(String(20), default="unknown")
